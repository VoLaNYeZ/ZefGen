...
const buildWebhookStatus = (payload: {
    ...
    return {
        webhook: {
            ...
            public_webhook_url: `https://${payload.publicSubdomain}.example.com/appstore-review?token=${publicToken}`,
        ...
        effective_public_webhook_url: `https://${payload.publicSubdomain}.example.com/appstore-review?token=${publicToken}`,
        effective_public_page_url: `https://${payload.publicSubdomain}.example.com/`,
        credential_issues: [],
